...
h1b=TH1D("valid_high","valid high PT", bins, xmin,xmax)
h1b.Sumw2()
h1b.SetLineWidth(2)
h1b.SetLineStyle(1)
h1b.SetLineColor(4);
...
h2b=TH1D("neuralnet_high","neuralnet hifg pT", bins, xmin,xmax)
h2b.Sumw2()
...
for i in xrange(len(data1_in)):
          ...
          nn1=nn1+1.0 
          nn2=nn2+1.0 
          if ( output1[1]>0 and inputs1[0]>100 and inputs1[0]<500): h1.Fill(  output1[0]/inputs1[0]  )
          if ( output2[1]>0 and inputs2[0]>100 and inputs2[0]<500): h2.Fill(  output2[0]/inputs2[0]  )
          if ( output1[1]>0 and inputs1[0]>1000 and inputs1[0]<2000): h1b.Fill(  output1[0]/inputs1[0]  )
          if ( output2[1]>0 and inputs2[0]>1000 and inputs2[0]<2000): h2b.Fill(  output2[0]/inputs2[0]  )
...
leg2.SetHeader("100<p_{T}<500 GeV:")
